...
<script type="text/javascript">
    $(document).ready(function() {
        $('#rincianpegawai').submit(function (event) {
            ...
            $.ajax({
                type:"POST",
                url:"prosesRincianPendidikanPegawai",
                data:dataString,
...
<div id="main">
	<div class="page-header">
		<h2> RINCIAN PENDIDIKAN PEGAWAI</h2>
	</div>
	<div class="row">
		<div class="col-sm-12">
			<div class="panel panel-default panel-shadow">
				<div class="panel-body">
						<form class="form-horizontal padding-15" action="prosesRincianPendidikanPegawai" method="POST" enctype="multipart/form-data" id="rincianpegawai">
