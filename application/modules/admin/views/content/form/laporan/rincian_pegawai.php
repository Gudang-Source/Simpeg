...
<div id="main">
	<div class="page-header">
		<h2> RINCIAN PEGAWAI</h2>
	</div>
	<div class="row">
		<div class="col-sm-12">
			<div class="panel panel-default panel-shadow">
				<div class="panel-body">
						<form class="form-horizontal padding-15" action="prosesRincianPegawai" method="POST" enctype="multipart/form-data" id="rincianpegawai">
