			...
			<div class="panel panel-default panel-shadow">
				<div class="panel-body">
					<form class="form-horizontal padding-15"  action="<?php echo $action; ?>" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">TANGGAL MULAI PELATIHAN</label>
							<div class="col-sm-9">
								<input type="text" name="input-tglmulaipelatihan" class="datepicker form-control" value="<?php echo $mode=='update' || $mode=='delete' ? $valuetglmulai : ""; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">TANGGAL AKHIR PELATIHAN</label>
							<div class="col-sm-9">
								<input type="text" name="input-tglakhirpelatihan" class="datepicker form-control" value="<?php echo $mode=='update' || $mode=='delete' ? $valuetglselesai : ""; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">URAIAN PELATIHAN</label>
							<div class="col-sm-9">
				...
				<div class="panel-body">
					...
					<table id="data-table" class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%">
						...
						<tr>
							...
							<th class="text-center">TANGGAL AWAL PELATIHAN</th>
							<th class="text-center">TANGGAL AKHIR PELATIHAN</th>
							<th class="text-center">URAIAN PELATIHAN</th>
						...
						<?php if($data->num_rows() > 0){ ?>
							<?php foreach($data->result_array() as $row){ ?>
								<tr>
									<td><?php echo $row['id_dt_pelatihan']; ?></td>
									<td><?php echo $row['nama_pegawai']; ?></td>
									<td><?php echo $row['lokasi']; ?></td>
									<td><?php echo $row['tgl_mulai_pelatihan']; ?></td>
									<td><?php echo $row['tgl_akhir_pelatihan']; ?></td>
									<td><?php echo $row['uraian_pelatihan']; ?></td>
									<td><?php echo $row['tgl_sertifikat']; ?></td>
									<td>
										<div class="media-left" id="links">
										    <a href="<?php echo base_url('assets/foto/sertifikat/pelatihan/'.$row['foto']); ?>" title="Photo Certificate" data-gallery>
										        <img src="<?php echo base_url('assets/foto/sertifikat/pelatihan/'.$row['foto']); ?>" alt="certificate" width="80">
										    </a>
										</div>
									</td>
									<td class="text-center">
										<?php $id = $row['id_dt_pelatihan']; ?>
